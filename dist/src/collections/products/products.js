    ...
    hooks: {
        beforeChange: [
            ...
            function (args) { return __awaiter(void 0, void 0, void 0, function () {
                var data, createProduct, updatedProduct, data, updatedProduct, update;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 1:
                            ...
                            updatedProduct = __assign(__assign({}, data), { stripeId: createProduct.id, priceId: createProduct.default_price });
                        ...
                        case 3:
                            ...
                            update = __assign(__assign({}, data), { stripeId: updatedProduct.id, priceId: updatedProduct.default_price });
