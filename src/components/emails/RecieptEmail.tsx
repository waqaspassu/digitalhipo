...
interface RecieptEmailHtmlProps {
  email: string;
  date: Date;
  orderId: string;
  products: Product[];
        ...
        <Container style={container}>
          <Section>
            <Row>
              <Column>
                <Img
                  src={`${process.env.NEXT_PUBLIC_SERVER_URL}/static/apple-logo.png`}
                  width="42"
                  height="42"
                  alt="Apple Logo"
                />
          ...
          <Section>
            <Row>
              <Column style={{ width: "64px" }}>
                <Img
                  src={`${process.env.NEXT_PUBLIC_SERVER_URL}/static/apple-hbo-max-icon.jpeg`}
                  width="64"
                  height="64"
                  alt="HBO Max"
                  style={productIcon}
          ...
          <Section>
            <Row>
              <Column align="center" style={block}>
                <Img
                  src={`${process.env.NEXT_PUBLIC_SERVER_URL}/static/apple-card-icon.png`}
                  width="60"
                  height="17"
                  alt="Apple Card"
                />
          ...
          <Section>
            <Row>
              <Column align="center" style={walletWrapper}>
                ...
                >
                  <Img
                    src={`${process.env.NEXT_PUBLIC_SERVER_URL}/static/apple-wallet.png`}
                    width="28"
                    height="28"
                    alt="Apple Wallet"
                    style={walletImage}
...
export const ReceiptEmailHtml = (props: RecieptEmailHtmlProps) =>
